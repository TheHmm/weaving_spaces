defmodule KnitMakerWeb.QuestionLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok, stream(socket, :questions, Events.list_questions())}
  end
  ...
  @impl true
  def handle_info({KnitMakerWeb.QuestionLive.FormComponent, {:saved, question}}, socket) do
  ...
  def handle_event("delete", %{"id" => id}, socket) do
    ...
    {:ok, _} = Events.delete_question(question)
